                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center">
                      ...
                      <span>abhishekmidha518@gmail.com</span>
                    </div>
                    <div className="flex items-center">
                      <Phone className="h-5 w-5 text-primary mr-3" />
                      <span>+91 7973709617</span>
                    </div>
                    <div className="flex items-center">
                  ...
                  <div className="pt-6">
                    ...
                    <div className="flex space-x-4">
                      ...
                      <motion.a
                        href="https://www.linkedin.com/in/abhishek-midha-qa"
                        target="_blank"
                        rel="noopener noreferrer"
                        whileHover={{ scale: 1.1 }}
                        whileTap={{ scale: 0.9 }}
                      ...
                      <motion.a
                        href="mailto:abhishekmidha518@gmail.com"
                        whileHover={{ scale: 1.1 }}
                        whileTap={{ scale: 0.9 }}
                        className="p-3 bg-muted rounded-full hover:bg-primary hover:text-primary-foreground transition-colors duration-200"
                      >
                  ...
                  <div className="pt-6 border-t border-border">
                    <p className="text-sm text-muted-foreground">
                      <strong>Available for:</strong> Full-time QA roles, automation testing projects, and collaboration on
                      enterprise testing initiatives.
                    </p>
                  </div>
                </CardContent>
              </Card>
